...
mod Account {
    ...
    use session_keys::Session::dapp_session_handler_component;

    component!(path: dapp_session_handler_component, storage: sk_s, event: sk_e);

    #[abi(embed_v0)]
    impl UserSessionKeybleImpl =
        dapp_session_handler_component::DappSessionHandlerable<ContractState>;
    impl UserSessionKeyInternalImpl = dapp_session_handler_component::InternalImpl<ContractState>;
    ...
    struct Storage {
        ...
        #[substorage(v0)]
        sk_s: dapp_session_handler_component::Storage,
    }
    ...
    enum Event {
        ...
        sk_e: dapp_session_handler_component::Event,
    }
